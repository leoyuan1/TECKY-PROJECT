...
async function main() {
    ...
    const post1_id = (await client.query("Insert into community_messages(title, content, media, community_id, created_at, updated_at) values ($1,$2,$3,$4,$5,$6) returning id", [
        post1.title,
        post1.content,
        post1.id,
        post1.created_at,
    ...
    await client.query("Insert into post_media(media_name, media_id, media_type) values ($1, $2, $3", [
